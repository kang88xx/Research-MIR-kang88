...
const EVENTS: Seed[] = [
  ...
  { date: "2026-08-17", ticker: "WBS", title: "와이오밍 블록체인 심포지엄 (8/17~20)", description: "SALT와 크라켄이 주최하는 3회차 와이오밍 블록체인 심포지엄이 잭슨홀 포시즌스에서 열린다. 연방 의원·정책 입안자·기관 투자자 500명이 모이는 초청제 정책 행사. (출처: SALT 공식)", category: "good", groupMain: "크립토", groupSub: "컨퍼런스", dateStatus: "confirmed", importance: 2, sources: [{ name: "SALT 공식", url: "https://www.salt.org/events/wyoming-blockchain-symposium-2026", tier: 1, isOfficial: true }, { name: "Coinpedia Events", url: "https://events.coinpedia.org/wyoming-blockchain-symposium-2026-8515/", tier: 2, isOfficial: false }] },
  { date: "2026-08-20", ticker: "COINFEST", title: "코인페스트 아시아 2026 발리 (8/20~21)", description: "인도네시아 크립토 네트워크(ICN)가 주최하는 세계 최대급 크립토 페스티벌 코인페스트 아시아가 발리 멜라스티 해변 일대 5개 비치클럽에서 열린다. 기관·빌더·트레이더 3개 트랙, 2만 명 규모. (출처: Coinfest Asia 공식)", category: "good", groupMain: "크립토", groupSub: "컨퍼런스", dateStatus: "confirmed", importance: 2, sources: [{ name: "Coinfest Asia 공식", url: "https://coinfest.asia/", tier: 1, isOfficial: true }, { name: "BitPinas", url: "https://bitpinas.com/feature/coinfest-asia-2026-scheduled/", tier: 3, isOfficial: false }] },
  { date: "2026-08-27", ticker: "BTCASIA", title: "비트코인 아시아 2026 홍콩 (8/27~28)", description: "BTC Inc.가 주최하는 아시아 최대 비트코인 컨퍼런스가 홍콩 컨벤션센터에서 열린다. 참가자 1만 5천 명·연사 200명 이상 규모로, 발라지 스리니바산 등이 헤드라인 연사로 나선다. (출처: Bitcoin Conference 공식)", category: "good", groupMain: "크립토", groupSub: "컨퍼런스", dateStatus: "confirmed", importance: 2, sources: [{ name: "Bitcoin Conference 공식", url: "https://tickets.b.tc/event/bitcoin-asia-2026", tier: 1, isOfficial: true }, { name: "crypto.news", url: "https://crypto.news/bitcoin-asia-2026-announces-first-wave-of-speakers-for-august-hong-kong-event/", tier: 3, isOfficial: false }] },
